...
const cardDefinitions: CardData[] = [
  ...
  { id: 2, name: 'Echoes in the Void', description: "We thought we were alone until the whispers started.", type: CardType.Event, rarity: Rarity.Common, imageUrl: 'https://cdn.midjourney.com/f267e837-3627-4551-a920-fb5f88cb7862/0_3.png', set: 'Space Horror', author: 'Fry', manaCost: 2, abilities: [{ name: 'Mind Static', description: "Opponent loses 1 point and discards a random card from their hand." }] },
  ...
  { id: 4, name: 'Solar Flare', description: "Light’s supposed to be good. Not this time.", type: CardType.Event, rarity: Rarity.Common, imageUrl: 'https://cdn.midjourney.com/e61578ec-04db-4f77-9043-b36a0c716500/0_3.png', set: 'Space Horror', author: 'Fry', manaCost: 2, abilities: [{ name: 'Overload', overloadCost: 5, description: "Opponent loses 2 points.", overloadDescription: "Opponent loses 5 points instead." }] },
  ...
  { id: 8, name: 'Message from the Stars', description: "They’re sending us coordinates. But why?", type: CardType.Artifact, rarity: Rarity.Uncommon, imageUrl: 'https://cdn.midjourney.com/961fa923-ecf2-498a-9c8c-2056dffba430/0_2.png', set: 'Space Horror', author: 'Fry', manaCost: 3, abilities: [{ name: 'Scrap', description: "Draw 2 cards.", discardsAfterUse: true }] },
  ...
  { id: 10, name: 'Cracked Reality', description: "Space bends. So does the mind.", type: CardType.Event, rarity: Rarity.Uncommon, imageUrl: 'https://cdn.midjourney.com/3ed2bfa9-4ecd-4a2b-a085-9ab42f59874e/0_3.png', set: 'Space Horror', author: 'Fry', manaCost: 3, abilities: [{ name: 'Cascade', description: "Reveal the top 3 cards of your deck. Play the first valid (non-Event, lower cost) card for free. Place the rest on the bottom of your deck in a random order." }] },
  { id: 11, name: 'Void Wanderer', description: "She’s not lost. She just prefers the emptiness.", type: CardType.Unit, rarity: Rarity.Uncommon, imageUrl: 'https://cdn.midjourney.com/7e826378-bcbf-4cdf-8c9a-2afaab3ad2c3/0_0.png', set: 'Space Horror', author: 'Fry', abilities: [{ name: 'Economist', description: 'Your first action (bet, raise, or call) each round costs 1 less point or mana.' }] },
  ...
  { id: 14, name: 'The Watcher Awakens', description: "It’s not that we found them. They let us.", type: CardType.Unit, rarity: Rarity.Rare, imageUrl: 'https://cdn.midjourney.com/b701c199-5a4d-4766-ab86-6000aab36c09/0_0.png', set: 'Space Horror', author: 'Fry', abilities: [{ name: 'Bulwark', description: "When an opponent plays a card that would affect you, reduce its numeric effects by 1. At the start of your turn, if you have fewer points than your opponent, gain 1 mana." }] },
  ...
  { id: 18, name: 'Nova Rebirth', description: "From destruction, something darker is born.", type: CardType.Event, rarity: Rarity.Rare, imageUrl: 'https://cdn.midjourney.com/abd8d0b0-4b9a-4728-b649-551d6bb6366a/0_0.png', set: 'Space Horror', author: 'Fry', manaCost: 4, abilities: [{ name: 'Cascade', description: "Reveal the top 3 cards of your deck. Play the first valid (non-Event, lower cost) card for free. Place the rest on the bottom of your deck in a random order." }] },
  ...
  { id: 29, name: 'Eternal Eclipse', description: "The stars blinked out. Then they never returned.", type: CardType.Event, rarity: Rarity.Rare, imageUrl: 'https://cdn.midjourney.com/9a5a35ce-4723-495f-878a-b6b8b9796924/0_0.png', set: 'Space Horror', author: 'Fry', manaCost: 7, abilities: [{ name: 'Wager', description: "For the rest of this round, all community cards are considered Spades. Opponent cannot play a card on their next turn." }] },
  { id: 30, name: 'The Young Explorer', description: "They were so eager to touch the stars. Now, they fear the dark.", type: CardType.Unit, rarity: Rarity.Common, imageUrl: 'https://cdn.midjourney.com/4ce664da-f9e0-4698-a32b-0baf79e595d7/0_3.png', set: 'Space Horror', author: 'Fry', abilities: [{ name: 'Underdog', value: 2, type: 'Mana', description: "If your hand is a High Card or One Pair at the showdown, you gain 2 mana." }] },
...
export const CARDS: CardData[] = cardDefinitions;
