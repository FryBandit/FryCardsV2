...
const cardDefinitions: CardData[] = [
  // --- Space Horror ---
  { id: 1, name: 'Lost Signal', description: "The stars used to speak. Now, it's just static.", type: CardType.Event, rarity: Rarity.Common, imageUrl: 'https://cdn.midjourney.com/3f14d43b-c6d3-4127-ada6-8b5178280105/0_2.png', set: 'Space Horror', author: 'Fry', manaCost: 1, abilities: [{ name: 'Gamble', description: "Reveal the top card of the river deck. If it's a face card (J, Q, K, A), draw a card. Otherwise, discard a card." }] },
  ...
  { id: 4, name: 'Solar Flare', description: "Light’s supposed to be good. Not this time.", type: CardType.Event, rarity: Rarity.Common, imageUrl: 'https://cdn.midjourney.com/e61578ec-04db-4f77-9043-b36a0c716500/0_3.png', set: 'Space Horror', author: 'Fry', manaCost: 2, abilities: [{ name: 'Overload', cost: 4, description: "Opponent loses 2 points.", overloadDescription: "Opponent loses 5 points instead." }] },
  ...
  { id: 10, name: 'Cracked Reality', description: "Space bends. So does the mind.", type: CardType.Event, rarity: Rarity.Uncommon, imageUrl: 'https://cdn.midjourney.com/3ed2bfa9-4ecd-4a2b-a085-9ab42f59874e/0_3.png', set: 'Space Horror', author: 'Fry', manaCost: 3, abilities: [{ name: 'Cascade', description: "When you play this, reveal cards from your deck until you reveal a non-Event card with a lower mana cost. Play it for free." }] },
  ...
  { id: 12, name: 'The Hunger', description: "The darkness wants more than just light.", type: CardType.Event, rarity: Rarity.SuperRare, imageUrl: 'https://cdn.midjourney.com/a4f8ace0-9061-43e0-8d0e-67198402d6fc/0_3.png', set: 'Space Horror', author: 'Fry', manaCost: 5, abilities: [{ name: 'Gamble', description: "Your opponent loses points equal to the number of cards in their hand." }] },
  ...
  { id: 15, name: "The Ship's Last Breath", description: "A ship isn’t just metal. It knows when it’s dying.", type: CardType.Artifact, rarity: Rarity.Rare, imageUrl: 'https://cdn.midjourney.com/6ea384ba-5267-47d7-a5ae-7ed4a64c3630/0_2.png', set: 'Space Horror', author: 'Fry', manaCost: 4, abilities: [{ name: 'Chrono (3)', description: "At the start of your turn, your opponent loses 1 point." }] },
  ...
  { id: 17, name: 'Stardust Memories', description: "All those who left before us... they're still here.", type: CardType.Event, rarity: Rarity.Rare, imageUrl: 'https://cdn.midjourney.com/3c8ab8e1-ddd7-4418-897c-a4bb7ada86f2/0_3.png', set: 'Space Horror', author: 'Fry', manaCost: 5, abilities: [{ name: 'Twin', description: "Copy this event. (Return a card from your discard pile to your hand)." }] },
  { id: 18, name: 'Nova Rebirth', description: "From destruction, something darker is born.", type: CardType.Event, rarity: Rarity.Rare, imageUrl: 'https://cdn.midjourney.com/abd8d0b0-4b9a-4728-b649-551d6bb6366a/0_0.png', set: 'Space Horror', author: 'Fry', manaCost: 4, abilities: [{ name: 'Cascade', description: "When you play this, reveal cards from your deck until you reveal a non-Event card with a lower mana cost. Play it for free." }] },
  ...
  { id: 23, name: 'The Last Transmission', description: "This is Captain Oran, and we are not alone.", type: CardType.Event, rarity: Rarity.SuperRare, imageUrl: 'https://cdn.midjourney.com/b289bfd0-6cfc-4298-84f6-48a47e37ab55/0_2.png', set: 'Space Horror', author: 'Fry', manaCost: 6, abilities: [{ name: 'Gamble', description: "Both players reveal their hole cards. If you have the higher ranked card, your opponent loses 5 points. Otherwise, you lose 5 points." }] },
  ...
  { id: 26, name: 'Singularity of Fear', description: "All the terror in the universe, compressed into one point.", type: CardType.Event, rarity: Rarity.Mythic, imageUrl: 'https://cdn.midjourney.com/dddf864a-2f3f-4dbb-9f85-e5dd446115fb/0_0.png', set: 'Space Horror', author: 'Fry', manaCost: 8, abilities: [{ name: 'Overload', cost: 12, description: "Your opponent loses half their points, rounded down.", overloadDescription: "Your opponent's points are set to 1." }] },
  { id: 27, name: 'Omen of the Starborn', description: "They come not to visit, but to reclaim.", type: CardType.Event, rarity: Rarity.Mythic, imageUrl: 'https://cdn.midjourney.com/39141111-38ba-4054-a255-3bbcc6a832c9/0_2.png', set: 'Space Horror', author: 'Fry', manaCost: 8, abilities: [{ name: 'Cascade', description: "When you play this, reveal cards from your deck until you reveal a non-Event card with a lower mana cost. Play it for free." }] },
  ...
  { id: 31, name: "The Violinist’s Last Song", description: "She played not to stop the end, but to fill it with meaning.", type: CardType.Unit, rarity: Rarity.Rare, imageUrl: 'https://cdn.midjourney.com/467bf321-1267-42b9-bc6d-dad9f794140b/0_2.png', set: "Humanity's Last Whisper", author: 'Fry', abilities: [{ name: 'Last Stand', description: "If you have 5 or fewer points at the start of the showdown, this card's rank is considered one higher for hand evaluation." }] },
  { id: 55, name: 'The Secret Ingredient', description: "Sometimes love is the secret ingredient. This time it's definitely ghost peppers.", type: CardType.Artifact, rarity: Rarity.SuperRare, imageUrl: 'https://cdn.midjourney.com/d635eb6d-62f9-4fad-8c52-e4556797bbd8/0_3.png', set: 'Culinary Boot Camp', author: 'Fry', manaCost: 7, abilities: [{ name: 'Imbue', cost: 2, description: "Grant one of your hole cards 'Last Stand' until the end of the round.", abilityToGrant: { name: 'Last Stand', description: "If you have 5 or fewer points at the start of the showdown, this card's rank is considered one higher for hand evaluation." } }] },
